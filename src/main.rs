...
fn adb_settings() {
    let vectors: Vec<Vec<&str>> = vec![
        ...
        // Charging settings
        vec!["settings", "put", "system", "charging_info_always", "1"],
        vec!["settings", "put", "system", "adaptive_fast_charging", "1"],
        vec!["settings", "put", "system", "wireless_fast_charging", "1"],
        ...
        vec!["settings", "put", "secure", "show_keyboard_button", "1"],
